#!/usr/bin/env python3
"""v53 launcher: amplitude prior MID-DOSE — v52 proved the lever (arms 2.7x
plateau at 0.3) but overdosed the form; this run finds the balance point.
...
Base: v45 model_7395 (disc intact). +1000 iters. PRIMARY: arms >= 30 deg. Secondary (the full-gate sweep): 13/13 AND P7 8/8
