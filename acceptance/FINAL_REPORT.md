...
**终版发布矩阵**：平台门 = v39 model_6297（13/13+P7 8/8+漂移 ✓+鲁棒 49/60）；
本地严格门 = v35 model_3999（G 全绿+55/60）；walk05 对称冠军 = v40 model_5498。
**残余缺口**：臂摆幅绝对值（最好 25.5/27.8 vs ref 92/83——v40 的减半平滑是最有效杠杆，
可与 3 项守卫组合成 v42）；push1.0 鲁棒性（三代 0-1/5，需满强度随机化相或联合调度再探）。
